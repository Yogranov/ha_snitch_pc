...
class Entity:
    ...
    def __init__(self, client, friendly_name, id, entity_type, unit_of_measurement, value_template, icon, tolerance = 5):
        self.client = client
    ...
    def send_config(self):
        payload = '{"name": "' + self.friendly_name + '", "state_topic": "' + self.state_topic + '", "unit_of_measurement": "' + self.unit_of_measurement + '", "value_template": "' + self.value_template + '", "icon": "' + self.icon + '" }'
